...
class TMDBService:
    ...
    def download_poster(self, poster_path: str, tmdb_id: int) -> Optional[str]:
    ...
    def get_movie_data_and_poster(self, title: str, year: Optional[int] = None) -> Tuple[Optional[int], Optional[str]]:
