...
def add_test_case(url: str, title: str, format_type: str = None, 
                  price_min: float = 10.0, price_max: float = 100.0,
                  notes: str = "", active: bool = True):
    """Add a new test case"""
...
def deactivate_test_case(name: str):
...
def activate_test_case(name: str):
